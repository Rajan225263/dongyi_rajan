...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">Attendances Reports for General Employee</h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <form id="myAttendanceSearchForm"  name="myAttendanceSearchForm" class="form-horizontal" action="#" method="get">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <label class="control-label" for="hrm_employee_id">Employee<span class="required">*</span></label>
        ...
        <!--/. container-fluid -->
         ...
         <script>
               ...
               $(document).ready(function () {
                 ...
                 function generateDatable(){
                          ...
                          var dataTableDynamic = $('#dataTableAttendance').DataTable({
                            ...
                            "ajax": {
                                    "url" : '{{ route('general-reports.grid') }}',
           ...
           function exportUrlUpdate(){
                ...
                var url = "{{ route('general-reports.exports') }}";
