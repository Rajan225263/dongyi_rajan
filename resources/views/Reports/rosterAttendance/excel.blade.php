 <table>
    <thead>
      <tr>
    <td colspan="11" align="center" valign="top" style="font-size: 15px;"><b>Attendance Report For Roster Employee </b></td>
  </tr>
  ...
  @endphp 
    <tr>
    <td colspan="11" align="center" valign="top" style="font-size: 15px;"><b>Roster Employee:</b> {{$employee}}, <b>&nbsp;Date:</b> {{$start_date}} <b> &nbsp;to&nbsp;</b> {{$end_date}}</td>
   </tr>
