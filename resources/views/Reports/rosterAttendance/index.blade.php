...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">Attendances Reports for Roster Employee</h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <form id="myAttendanceSearchForm"  name="myAttendanceSearchForm" class="form-horizontal" action="#" method="get">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <label class="control-label" for="hrm_employee_id">Roster Employee<span class="required">*</span></label>
        ...
        <!--/. container-fluid -->
         ...
         <script>
             ...
             function generateDatable(){
               ...
               // "bScrollCollapse": true,
                 columns: [
                   ...
                   {data: 'working_our', name: 'working_our', "width": "10%"},
                    {data: 'in_time', name: 'in_time', "width": "5%"},
                    {data: 'in_late', name: 'in_late', "width": "5%"},
                    {data: 'out_time', name: 'out_time', "width": "5%"},
                    {data: 'early_out', name: 'early_out', "width": "5%"},
           ...
           function exportUrlUpdate(){
                ...
                var url = "{{ route('roster-reports.exports') }}";
