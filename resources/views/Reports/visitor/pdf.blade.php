...
<tr>
    <td colspan="11" align="center" valign="top"><b>In/Out Report For visitors</b></td>
  </tr>
   <tr>
    ...
    <td colspan="11" align="center" valign="top"><b>Visitor:</b> {{$employee}}, <b>Date:</b> {{$start_date}} <b>to</b> {{$end_date}}</td>
  </tr>
</table>
...
<table width="100%" border="1" align="center" id="reportTable">
 ...
 <thead>
  <tr>
    ...
    <th width="15%" align="left" valign="middle">User ID</th>
    <th width="9%" align="left" valign="middle">Visitor Name</th>
