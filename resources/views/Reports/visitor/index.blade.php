...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">In/Out Reports for visitors</h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <form id="myAttendanceSearchForm"  name="myAttendanceSearchForm" class="form-horizontal" action="#" method="get">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <label class="control-label" for="hrm_employee_id">visitors<span class="required">*</span></label>
                                <select id="hrm_employee_id" name="hrm_employee_id" class="form-control form-control-sm select2" required>
                                    ...
                                    @foreach ($employeeList as $list)
                                        @if($list['id']==old('hrm_employee_id'))
                                            <option selected
                                                    value="{{$list['id']}}">{{$list['name']}} ({{$list['mobile']}})</option>
                                        @else
        ...
        <!--/. container-fluid -->
         ...
         <script>
             ...
             function generateDatable(){
                ...
                "ajax": {
                        "url" : '{{ route('visitor-reports.grid') }}',
               ...
               // "bScrollCollapse": true,
                 columns: [
                    ...
                    {data: 'card_no', name: 'card_no', "width": "10%"},
           ...
           function exportUrlUpdate(){
                ...
                var url = "{{ route('visitor-reports.exports') }}";
