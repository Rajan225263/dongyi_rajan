...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4 class="m-0 text-dark">Attendances Reports for Contractor</h4>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <form id="myAttendanceSearchForm"  name="myAttendanceSearchForm" class="form-horizontal" action="#" method="get">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <label class="control-label" for="hrm_employee_id">Contractor<span class="required">*</span></label>
        ...
        <!--/. container-fluid -->
         ...
         <script>
             ...
             function generateDatable(){
                ...
                "ajax": {
                        "url" : '{{ route('contractor-reports.grid') }}',
           ...
           function exportUrlUpdate(){
                ...
                var url = "{{ route('contractor-reports.exports') }}";
