...
<tr>
    <td colspan="11" align="center" valign="top"><b>Attendance Report For House keepers</b></td>
  </tr>
   <tr>
    ...
    <td colspan="11" align="center" valign="top"><b>House keeper:</b> {{$employee}}, <b>Date:</b> {{$start_date}} <b>to</b> {{$end_date}}</td>
  </tr>
</table>
